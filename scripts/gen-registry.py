...
# id → (тўлиқ ном, қисқа ёрлиқ, доира ичидаги белги)
AG = {
    'social': ('Ижтимоий ҳимоя миллий агентлиги', 'Ижтимоий ҳимоя', 'ИҲ'),
    'etrm': ('Электрон технологияларни ривожлантириш маркази', 'ЭТРМ', 'ЭТРМ'),
    'insurance': ('Давлат тиббий суғурта жамғармаси', 'Тиббий суғурта', 'ДТСЖ'),
    'hisob': ('Ҳисоб палатаси', 'Ҳисоб палатаси', 'ҲП'),
    'soliq': ('Солиқ қўмитаси', 'Солиқ қўмитаси', 'СҚ'),
    'iiv': ('Ички ишлар вазирлиги', 'ИИВ', 'ИИВ'),
    'moliya': ('Иқтисодиёт ва молия вазирлиги', 'Иқтисод-молия', 'ИМВ'),
    'mudofaa': ('Мудофаа вазирлиги', 'Мудофаа', 'МВ'),
    'adliya': ('Адлия вазирлиги', 'Адлия', 'АВ'),
    'yoshlar': ('Ёшлар ишлари агентлиги', 'Ёшлар агентлиги', 'ЁИА'),
    'maktab': ('Мактаб ва мактабгача таълим вазирлиги', 'Мактаб таълими', 'МТВ'),
    'oila': ('Оила ва хотин-қизлар қўмитаси', 'Оила қўмитаси', 'ОХҚ'),
    'tech': ('Техник тартибга солиш агентлиги', 'Техник тартиб', 'ТТС'),
    'pharm': ('Фармацевтика ривожлантириш агентлиги', 'Фармацевтика', 'ФРА'),
    'oits': ('ОИТСга қарши курашиш маркази', 'ОИТС маркази', 'ОИТС'),
    'rh': ('«Рақамли ҳукумат» платформаси', 'Рақамли ҳукумат', 'РҲ'),
}
...
def main(path):
    ...
    for ag, (name, label, mark) in AG.items():
        ...
        nodes.append({
            ...
            'status': 'live' if active == len(kids) else 'plan',
            'children': kids,
        })
